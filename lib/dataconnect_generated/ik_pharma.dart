...
class IkPharmaConnector {
  ...
  CreateBusinessAndAdminVariablesBuilder createBusinessAndAdmin ({required String businessName, required String userEmail, required String userFirstName, required String userLastName, required String authUid, }) {
    return CreateBusinessAndAdminVariablesBuilder(dataConnect, businessName: businessName,userEmail: userEmail,userFirstName: userFirstName,userLastName: userLastName,authUid: authUid,);
  }
